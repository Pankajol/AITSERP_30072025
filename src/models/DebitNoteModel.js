...
// Batch sub‑schema (matches frontend)
...
// Item sub‑schema (matches frontend well)
const ItemSchema = new Schema({
  ...
  selectedBin: { type: Schema.Types.ObjectId, ref: 'Bin' },
...
const DebitNoteSchema = new Schema({
  ...
  sourceModel: { type: String, enum: ['PurchaseInvoice'] },
  supplier: { type: Schema.Types.ObjectId, ref: 'Supplier', required: true },
  supplierCode: { type: String },
  supplierName: { type: String },
  contactPerson: { type: String },
  refNumber: { type: String },
  documentNumberDebitNote: { type: String, required: true, unique: true },
...
DebitNoteSchema.index({ supplier: 1, postingDate: -1 });
