...
const ItemSchema = new Schema({
  ...
  managedBy: { type: String, default: "none" },
  batches: [BatchSchema],
  warehouse: { type: Schema.Types.ObjectId, ref: "Warehouse", required: true },
  warehouseName: { type: String },
  warehouseCode: { type: String },
  stockImpact: { type: Boolean, default: true },
  // Variant support
  variant: {
...
const CreditNoteSchema = new Schema({
  ...
  documentNumberCreditNote: { type: String, required: true, unique: true },
  salesInvoiceId: { type: Schema.Types.ObjectId, ref: "SalesInvoice" },
