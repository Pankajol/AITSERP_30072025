...
function GRNForm() {
  ...
  //         !it.selectedBin || // Check if bin is selected
  ...
  //             !b.batchNumber || b.batchNumber.trim() === "" || (Number(b.batchQuantity) || 0) <= 0 ||  !b.selectedBin 
  //         );
  ...
  //       batches: ArrayOf(it.batches).filter(b => b.batchNumber && b.batchNumber.trim() !== "" && Number(b.batchQuantity) > 0).map(({ id, ...rest , binId: rest.selectedBin?._id || null }) )
  //     }));
