  ...
  useEffect(() => {
    if (editData) {
      setForm({
        ...
        balanceType: editData.balanceType || "Debit",
...
export default function AccountHeadPage() {
  ...
  return (
    <>
      ...
      `}</style>
      <Toast toasts={toasts} />
      <Modal open={showModal} onClose={() => { setShowModal(false); setEditData(null); }} onSave={handleSave} editData={editData} />
...
// const GROUPS = {
//   Asset:     ["Current Asset", "Fixed Asset", "Other Asset", "Bank Account"],
