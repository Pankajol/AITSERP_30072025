...
export default function GuardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Header */}
      <header className="guard-header bg-white border-b border-gray-200 fixed top-0 left-0 right-0 z-30 shadow-sm max-w-md mx-auto">
      ...
      {/* Main content */}
      <div
        className="guard-content max-w-md mx-auto w-full"
        style={{
      ...
      {/* Bottom navigation */}
      <nav className="guard-nav bg-white border-t border-gray-200 fixed bottom-0 left-0 right-0 z-30 shadow-[0_-1px_8px_rgba(0,0,0,0.06)] max-w-md mx-auto">
