...
import { FiEye, FiEyeOff, FiMail, FiLock, FiChevronRight, FiLoader, FiUser, FiBriefcase } from 'react-icons/fi';
...
export default function LoginPage() {
  ...
  // Helper to detect if user has any election-related role
