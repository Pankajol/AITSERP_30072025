...
export async function GET(req) {
  ...
  if (token) {
    // Microsoft expects plain text response
...
export async function POST(req) {
  try {
    ...
    // Forward events async (do NOT await)
    fetch(
      `${process.env.NEXT_PUBLIC_APP_URL}/api/helpdesk/outlook-process`,
      {
        method: "POST",
