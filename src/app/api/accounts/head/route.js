...
export async function GET(req) {
  try {
    ...
    const type   = searchParams.get("type");   // Asset | Liability | Equity | Income | Expense
    const group  = searchParams.get("group");
    const search = searchParams.get("search");
    const init   = searchParams.get("init");   // "true" → create defaults if none exist
    ...
    // ✅ Auto-create defaults if company has no account heads yet
