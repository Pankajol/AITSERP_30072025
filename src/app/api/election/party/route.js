// app/api/election/party/route.js
...
export async function GET(req) {
  ...
  if (!hasPermission(user, "Parties / Candidates", "view")) {
...
export async function POST(req) {
  ...
  if (!hasPermission(user, "Parties / Candidates", "create")) {
    return NextResponse.json({ success: false, message: "Forbidden" }, { status: 403 });
  }
...
export async function PUT(req) {
  ...
  if (!hasPermission(user, "Parties / Candidates", "edit")) {
    return NextResponse.json({ success: false, message: "Forbidden" }, { status: 403 });
  }
...
export async function DELETE(req) {
  ...
  if (!hasPermission(user, "Parties / Candidates", "delete")) {
    return NextResponse.json({ success: false, message: "Forbidden" }, { status: 403 });
  }
