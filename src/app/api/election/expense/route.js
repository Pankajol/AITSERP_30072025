...
// app/api/election/expense/route.js
...
export async function GET(req) {
  ...
  if (!hasPermission(user, "Election Expenses", "view")) {
...
export async function POST(req) {
  ...
  if (!hasPermission(user, "Election Expenses", "create")) {
    return NextResponse.json({ success: false, message: "Forbidden" }, { status: 403 });
  }
...
export async function PUT(req) {
  ...
  if (!hasPermission(user, "Election Expenses", "edit")) {
    return NextResponse.json({ success: false, message: "Forbidden" }, { status: 403 });
  }
...
export async function DELETE(req) {
  ...
  if (!hasPermission(user, "Election Expenses", "delete")) {
    return NextResponse.json({ success: false, message: "Forbidden" }, { status: 403 });
  }
