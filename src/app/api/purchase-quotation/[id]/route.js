...
// ✅ PUT: Update PQ (with attachments)
export async function PUT(req, { params }) {
  ...
  try {
    ...
    if (isSimpleUpdate) {
      ...
      updatedQuotation = await PurchaseQuotation.findByIdAndUpdate(id, updateData, {
        new: true,
...
export async function DELETE(req, { params }) {
  try {
    ...
    await PurchaseQuotation.findByIdAndDelete(id);
